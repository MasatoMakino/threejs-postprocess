...
/******/ 	deferredModules.push(["./demoSrc/demoDisplacement.js","vendor"]);
...
/***/ "./bin/displacement/DisplacementMap.frag.glsl.js":
/*!*******************************************************!*\
  !*** ./bin/displacement/DisplacementMap.frag.glsl.js ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (function () {\n  //language=GLSL\n  return \"\\nuniform sampler2D tDiffuse;\\nvarying vec2 vUv;\\n\\nuniform float strengthX;\\nuniform float strengthY;\\nuniform bool hasMap;\\nuniform sampler2D map;\\nuniform vec2 aspect;\\n\\nvoid main() {\\n  vec2 uv = vUv;\\n  if( hasMap ){\\n    vec2 fixedUV = vUv - 0.5;\\n    fixedUV *= aspect;\\n    fixedUV += 0.5;\\n    \\n    vec4 displacement = texture2D( map, fixedUV );\\n    uv +=  displacement.rg * vec2 (strengthX, strengthY);\\n }\\n\\n  vec4 color = texture2D( tDiffuse, uv );\\n  gl_FragColor = color;\\n}\\n  \";\n});\n\n//# sourceURL=webpack:///./bin/displacement/DisplacementMap.frag.glsl.js?");

/***/ }),

/***/ "./bin/displacement/DisplacementMapShader.js":
/*!***************************************************!*\
  !*** ./bin/displacement/DisplacementMapShader.js ***!
  \***************************************************/
/*! exports provided: DisplacementMapShader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"DisplacementMapShader\", function() { return DisplacementMapShader; });\n/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! three */ \"./node_modules/three/build/three.module.js\");\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../index */ \"./bin/index.js\");\n/* harmony import */ var _DisplacementMap_frag_glsl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DisplacementMap.frag.glsl */ \"./bin/displacement/DisplacementMap.frag.glsl.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _get(target, property, receiver) { if (typeof Reflect !== \"undefined\" && Reflect.get) { _get = Reflect.get; } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return _get(target, property, receiver || target); }\n\nfunction _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf(object); if (object === null) break; } return object; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n\n\n\n\nvar DisplacementMapShader =\n/*#__PURE__*/\nfunction (_PostProcessShader) {\n  _inherits(DisplacementMapShader, _PostProcessShader);\n\n  function DisplacementMapShader() {\n    var _this;\n\n    _classCallCheck(this, DisplacementMapShader);\n\n    _this = _possibleConstructorReturn(this, _getPrototypeOf(DisplacementMapShader).call(this));\n    _this.fragmentShader = Object(_DisplacementMap_frag_glsl__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n    return _this;\n  }\n\n  _createClass(DisplacementMapShader, [{\n    key: \"initUniform\",\n    value: function initUniform() {\n      _get(_getPrototypeOf(DisplacementMapShader.prototype), \"initUniform\", this).call(this);\n\n      this.uniforms = three__WEBPACK_IMPORTED_MODULE_0__[\"UniformsUtils\"].merge([this.uniforms, {\n        strengthX: {\n          value: 0.0\n        },\n        strengthY: {\n          value: 0.0\n        },\n        map: {\n          value: null\n        },\n        hasMap: {\n          value: false\n        },\n        aspect: {\n          value: new three__WEBPACK_IMPORTED_MODULE_0__[\"Vector2\"](1.0, 1.0)\n        }\n      }]);\n    }\n  }]);\n\n  return DisplacementMapShader;\n}(_index__WEBPACK_IMPORTED_MODULE_1__[\"PostProcessShader\"]);\n\n//# sourceURL=webpack:///./bin/displacement/DisplacementMapShader.js?");

/***/ }),

/***/ "./bin/displacement/DisplacementMapShaderPass.js":
/*!*******************************************************!*\
  !*** ./bin/displacement/DisplacementMapShaderPass.js ***!
  \*******************************************************/
/*! exports provided: DisplacementMapShaderPass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"DisplacementMapShaderPass\", function() { return DisplacementMapShaderPass; });\n/* harmony import */ var _DisplacementMapShader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DisplacementMapShader */ \"./bin/displacement/DisplacementMapShader.js\");\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../index */ \"./bin/index.js\");\n/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! three */ \"./node_modules/three/build/three.module.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _get(target, property, receiver) { if (typeof Reflect !== \"undefined\" && Reflect.get) { _get = Reflect.get; } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return _get(target, property, receiver || target); }\n\nfunction _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf(object); if (object === null) break; } return object; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n\n\n\n\n/**\n * DisplacementMapによって画面を歪ませるShaderPass\n */\n\nvar DisplacementMapShaderPass =\n/*#__PURE__*/\nfunction (_PostProcessShaderPas) {\n  _inherits(DisplacementMapShaderPass, _PostProcessShaderPas);\n\n  function DisplacementMapShaderPass() {\n    _classCallCheck(this, DisplacementMapShaderPass);\n\n    return _possibleConstructorReturn(this, _getPrototypeOf(DisplacementMapShaderPass).call(this, new _DisplacementMapShader__WEBPACK_IMPORTED_MODULE_0__[\"DisplacementMapShader\"]()));\n  }\n\n  _createClass(DisplacementMapShaderPass, [{\n    key: \"loadMap\",\n\n    /**\n     * DisplacementMapを読み込む。\n     * 読み込み後にアスペクト比の補正を行う。\n     *\n     * @param url\n     */\n    value: function loadMap(url) {\n      var _this = this;\n\n      var texture = new three__WEBPACK_IMPORTED_MODULE_2__[\"TextureLoader\"]().load(url, function (texture) {\n        _this.mapSizeW = texture.image.width;\n        _this.mapSizeH = texture.image.height;\n\n        _this.updateAspect();\n      });\n      this.uniforms.map.value = texture;\n      this.uniforms.hasMap.value = texture != null;\n    }\n  }, {\n    key: \"setSize\",\n    value: function setSize(width, height) {\n      _get(_getPrototypeOf(DisplacementMapShaderPass.prototype), \"setSize\", this).call(this, width, height);\n\n      this.rendererSizeW = width;\n      this.rendererSizeH = height;\n      this.updateAspect();\n    }\n  }, {\n    key: \"updateAspect\",\n    value: function updateAspect() {\n      if (this.mapSizeW == null || this.rendererSizeW == null) {\n        return;\n      }\n\n      var rendererAspect = this.rendererSizeW / this.rendererSizeH;\n      var mapAspect = this.mapSizeW / this.mapSizeH;\n\n      if (rendererAspect > mapAspect) {\n        this.uniforms.aspect.value = new three__WEBPACK_IMPORTED_MODULE_2__[\"Vector2\"](1.0, mapAspect / rendererAspect);\n      } else {\n        this.uniforms.aspect.value = new three__WEBPACK_IMPORTED_MODULE_2__[\"Vector2\"](rendererAspect / mapAspect, 1.0);\n      }\n    }\n  }, {\n    key: \"map\",\n    get: function get() {\n      return this.uniforms.map.value;\n    }\n  }, {\n    key: \"strengthX\",\n    get: function get() {\n      return this.uniforms.strengthX.value;\n    },\n    set: function set(value) {\n      this.uniforms.strengthX.value = value;\n    }\n  }, {\n    key: \"strengthY\",\n    get: function get() {\n      return this.uniforms.strengthY.value;\n    },\n    set: function set(value) {\n      this.uniforms.strengthY.value = value;\n    }\n  }]);\n\n  return DisplacementMapShaderPass;\n}(_index__WEBPACK_IMPORTED_MODULE_1__[\"PostProcessShaderPass\"]);\n\n//# sourceURL=webpack:///./bin/displacement/DisplacementMapShaderPass.js?");

/***/ }),

/***/ "./bin/displacement/index.js":
/*!***********************************!*\
  !*** ./bin/displacement/index.js ***!
  \***********************************/
/*! exports provided: DisplacementMapShaderPass */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _DisplacementMapShaderPass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DisplacementMapShaderPass */ \"./bin/displacement/DisplacementMapShaderPass.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"DisplacementMapShaderPass\", function() { return _DisplacementMapShaderPass__WEBPACK_IMPORTED_MODULE_0__[\"DisplacementMapShaderPass\"]; });\n\n\n\n//# sourceURL=webpack:///./bin/displacement/index.js?");

/***/ }),

/***/ "./bin/fxaa/FXAAShaderPass.js":
/*!************************************!*\
  !*** ./bin/fxaa/FXAAShaderPass.js ***!
  \************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"FXAAShaderPass\", function() { return FXAAShaderPass; });\n/* harmony import */ var three_examples_jsm_shaders_FXAAShader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! three/examples/jsm/shaders/FXAAShader */ \"./node_modules/three/examples/jsm/shaders/FXAAShader.js\");\n/* harmony import */ var _postprocess__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../postprocess */ \"./bin/postprocess/index.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _get(target, property, receiver) { if (typeof Reflect !== \"undefined\" && Reflect.get) { _get = Reflect.get; } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return _get(target, property, receiver || target); }\n\nfunction _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf(object); if (object === null) break; } return object; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n\n\n/**\n * FXAAShaderを組み込み済みのShaderPass\n */\n\nvar FXAAShaderPass =\n/*#__PURE__*/\nfunction (_PostProcessShaderPas) {\n  _inherits(FXAAShaderPass, _PostProcessShaderPas);\n\n  /**\n   * コンストラクタ\n   */\n  function FXAAShaderPass() {\n    _classCallCheck(this, FXAAShaderPass);\n\n    return _possibleConstructorReturn(this, _getPrototypeOf(FXAAShaderPass).call(this, three_examples_jsm_shaders_FXAAShader__WEBPACK_IMPORTED_MODULE_0__[\"FXAAShader\"]));\n  }\n\n  _createClass(FXAAShaderPass, [{\n    key: \"setSize\",\n    value: function setSize(width, height) {\n      _get(_getPrototypeOf(FXAAShaderPass.prototype), \"setSize\", this).call(this, width, height);\n\n      var uniforms = this.material.uniforms;\n      uniforms.resolution.value.x = 1 / width;\n      uniforms.resolution.value.y = 1 / height;\n    }\n  }]);\n\n  return FXAAShaderPass;\n}(_postprocess__WEBPACK_IMPORTED_MODULE_1__[\"PostProcessShaderPass\"]);\n\n//# sourceURL=webpack:///./bin/fxaa/FXAAShaderPass.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _FXAAShaderPass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FXAAShaderPass */ \"./bin/fxaa/FXAAShaderPass.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"FXAAShaderPass\", function() { return _FXAAShaderPass__WEBPACK_IMPORTED_MODULE_0__[\"FXAAShaderPass\"]; });\n\n\n\n//# sourceURL=webpack:///./bin/fxaa/index.js?");
...
/*!**********************************!*\
  !*** ./bin/postprocess/index.js ***!
  \**********************************/
/*! exports provided: PostProcessRenderer, RenderPassOption, PostProcessShader, PostProcessShaderPass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
